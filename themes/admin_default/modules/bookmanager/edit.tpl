        ...
        <form method="post" action="{FORM_ACTION}" enctype="multipart/form-data">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="publish_year" name="publish_year" value="{DATA.publish_year}" min="1800" max="2100">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <div class="col-md-4">
                    <!-- BEGIN: current_image -->
                    <div class="form-group">
                        <label>{GLANG.current_image}</label>
                        <div class="thumbnail">
                            <img src="{CURRENT_IMAGE}" class="img-responsive" style="max-height: 200px;">
                        </div>
                    </div>
                    <!-- END: current_image -->
