...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_68f48cdec77701_18107261',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '458d779c4fee3119c4994ac76fdf70aeed2c59ef' => 
    array (
      0 => 'upload.js',
      1 => 1756839092,
      2 => 'file',
...
function content_68f48cdec77701_18107261 (\Smarty\Template $_smarty_tpl) {
...
(() => {
    const loadApp = () => {
        ...
        // Extra
        <?php if ($_smarty_tpl->getValue('EXTRA_JS') != '') {?>amountJs++;
        // Tải callback của trình soạn thảo
        loadScript("<?php echo $_smarty_tpl->getValue('EXTRA_JS');?>
");
        <?php }?>
...
!nukeviet.Picker && (nukeviet.Picker = class {
    htmlModal = `<?php echo $_smarty_tpl->getValue('HTML_POPUP');?>
`;
    htmlContainer = `<?php echo $_smarty_tpl->getValue('HTML_CONTENT');?>
`;
    htmlDialog = `<?php echo $_smarty_tpl->getValue('HTML_DIALOG');?>
`;
    htmlQueueItem = `<?php echo $_smarty_tpl->getValue('HTML_QUEUE_ITEM');?>
`;
    htmlModalBackdrop = `<div class="fmm-backdrop fade"></div>`;
    htmlDialogBackdrop = `<div class="fmd-backdrop fade"></div>`;
    lang = {
        errorMinX: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('errorMinX');?>
`,
        errorMaxX: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('errorMaxX');?>
`,
        errorMinY: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('errorMinY');?>
`,
        errorMaxY: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('errorMaxY');?>
`,
        errorEmptyY: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('errorEmptyY');?>
`,
        errorEmptyX: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('errorEmptyX');?>
`,
        limitMin: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('limit_min');?>
`,
        limitMax: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('limit_max');?>
`,
        notlogo: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('notlogo');?>
`,
        moveMultiple: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('move_multiple');?>
`,
        delFolderConfirm: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('delete_folder');?>
`,
        delImgConfirm: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('upload_delimg_confirm');?>
`,
        delImgsConfirm: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('upload_delimgs_confirm');?>
`,
        copied: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('filepathcopied');?>
`,
        select: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('select');?>
`,
        compressImage: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('compressimage');?>
`,
        webpConvert: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('webpconvert');?>
`,
        qualityChange: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('qualitychange');?>
`,
        deleteFile: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('upload_delfile');?>
`,
        rename: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('rename');?>
`,
        move: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('move');?>
`,
        rotate: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('rotate');?>
`,
        crop: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('crop');?>
`,
        imgTool: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('upload_createimage');?>
`,
        addLogo: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('addlogo');?>
`,
        preview: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('preview');?>
`,
        download: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('download');?>
`,
        deleteDir: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('deletefolder');?>
`,
        renameDir: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('renamefolder');?>
`,
        reThumb: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('recreatethumb');?>
`,
        createDir: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('createfolder');?>
`,
        altRequired: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('upload_alt_note');?>
`,
        filesSelected: `<?php echo $_smarty_tpl->getValue('LANG')->getModule('files_selected');?>
`
    }
    ...
    constructor(element, options) {
        ...
        this.constant = {
            logo: '<?php echo $_smarty_tpl->getValue('UPLOAD_LOGO');?>
',
            compressImage: <?php echo $_smarty_tpl->getValue('COMPRESS_IMAGE_ACTIVE');?>
,
            autoAlt: <?php echo $_smarty_tpl->getValue('UPLOAD_AUTO_ALT');?>
,
            altRequire: <?php echo $_smarty_tpl->getValue('UPLOAD_ALT_REQUIRE');?>
,
            logoSize: {
                width: <?php echo $_smarty_tpl->getValue('LOGO_WIDTH');?>
,
                height: <?php echo $_smarty_tpl->getValue('LOGO_HEIGHT');?>
,
                sizeS: <?php echo $_smarty_tpl->getValue('LOGO_SIZE_S');?>
,
                sizeM: <?php echo $_smarty_tpl->getValue('LOGO_SIZE_M');?>
,
                sizeL: <?php echo $_smarty_tpl->getValue('LOGO_SIZE_L');?>

            },
            image: {
                minWidth: 10,
                minHeight: 10,
                maxWidth: <?php echo $_smarty_tpl->getValue('MAX_WIDTH');?>
,
                maxHeight: <?php echo $_smarty_tpl->getValue('MAX_HEIGHT');?>
        ...
        this.debug = <?php echo $_smarty_tpl->getValue('DEBUG');?>
;
        this.init();
    }
    ...
    initUploader() {
        ...
        self.up = new plupload.Uploader({
            ...
            filters: {
                max_file_size: <?php echo $_smarty_tpl->getValue('NV_MAX_SIZE_BYTES');?>
,
                mime_types: []
            },
            chunk_size: <?php echo $_smarty_tpl->getValue('NV_CHUNK_SIZE');?>
,
            resize: false,
            init: {
                FilesAdded: (up, files) => {
